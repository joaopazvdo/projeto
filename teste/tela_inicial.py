...
def desenha_tela_incial(TELA, opcoes):
    ...
    titulo = fonte_titulo.render('TERRA À VISTA', False, cores['branco'])
...
def tela_inicial():
    ...
    opcoes = [['Iniciar', Retangulo(44,50,10,5.5,TELA)],
              ['Fase 1', Retangulo(44,55.5,10,5.5,TELA)],
              ['Fase 2', Retangulo(44,61,10,5.5,TELA)],
              ['Fase 3', Retangulo(44,66.5,10,5.5,TELA)],
              ['Fase 4', Retangulo(44,72,10,5.5,TELA)],
              ['Sair', Retangulo(44,77.5,10,5.5,TELA)]]
    for i in range(len(opcoes)):
        opcoes[i][1].aparece = False
